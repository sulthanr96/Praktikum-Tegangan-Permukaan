...
export const Footer: React.FC = () => {
  return (
    <footer className="w-full bg-white shadow-[0_-4px_20px_-2px_rgba(15,23,42,0.03)] mt-16 border-t border-[#cbd5e1]/40">
      <div className="max-w-[1400px] mx-auto px-6 py-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
      ...
      <div className="bg-[#eff4ff] py-3 border-t border-[#cbd5e1]/30">
        <div className="max-w-[1400px] mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-2 text-[#42474f] font-['JetBrains_Mono'] text-xs">
          <span>© 2025 SURFTEN LAB · Sistem Terintegrasi Praktikum Kimia Fisik UI</span>
